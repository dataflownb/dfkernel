...
casper.notebook_test(function () {
    ...
    this.then(function () {
        ...
        this.test.assertEquals(outputs[1].data['text/plain'], '5', 'after modification, cell 0 produces the correct second output');
        this.test.assertEquals(outputs[1].metadata.output_tag, 'c', 'after modification, cell 0 has the correct second output_tag');
        this.test.assertEquals(outputs[2].data['text/plain'], '6', 'after modification, cell 0 produces the correct third output');
