...
class IPKernelApp(BaseIPythonApplication, InteractiveShellApp,
    ...
    kernel_class = Type('dfkernel.ipkernel.IPythonKernel',
                        klass='dfkernel.kernelbase.Kernel',
    ...
    def init_kernel(self):
        ...
        sys.stdout.get_execution_count = lambda: kernel.execution_count
        sys.stderr.get_execution_count = lambda: kernel.execution_count
    ...
    def init_gui_pylab(self):
        ...
        if not os.environ.get('MPLBACKEND'):
            os.environ['MPLBACKEND'] = 'module://dfkernel.pylab.backend_inline'
