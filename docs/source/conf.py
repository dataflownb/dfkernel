...
# -*- coding: utf-8 -*-
#
# dfpy_kernel documentation build configuration file, created by
# sphinx-quickstart on Tue Jul 11 19:44:12 2017.
#
...
htmlhelp_basename = 'dfpy_kerneldoc'
...
man_pages = [
    (master_doc, 'dfpy_kernel', 'dfpy_kernel Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dfpy_kernel', 'dfpy_kernel Documentation',
     author, 'dfpy_kernel', 'One line description of project.',
     'Miscellaneous'),
]
